class Snapshot(object):
    ...
    :param regions: An array of the regions that the image is available in. The regions are
    ...
    :param min_disk_size: The minimum size in GB required for a volume or Droplet to use this
                          snapshot.
