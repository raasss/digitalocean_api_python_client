...
class DropletActionResource(Api):
    ...
    def enable_backups(self, droplet_id=None, tag=None):
        ...
        request_method = "POST"
        request_body = {"type": "enable_backups"}
    ...
    def disable_backups(self, droplet_id=None, tag=None):
        if droplet_id is not None and tag is None:
            api_uri_query = "/{}/actions".format(droplet_id)
            response_body_json_key = "action"
        elif tag is not None and droplet_id is None:
        ...
        request_method = "POST"
        request_body = {"type": "disable_backups"}
        response_header_status_ok = 201
    ...
    def power_off(self, droplet_id=None, tag=None):
        if droplet_id is not None and tag is None:
            api_uri_query = "/{}/actions".format(droplet_id)
            response_body_json_key = "action"
        elif tag is not None and droplet_id is None:
    ...
    def power_on(self, droplet_id=None, tag=None):
        if droplet_id is not None and tag is None:
            api_uri_query = "/{}/actions".format(droplet_id)
            response_body_json_key = "action"
        elif tag is not None and droplet_id is None:
